...
public class TreeView extends Display {
	...
	public static final String TREE_CHI = "/resources/chi-ontology.xml.gz";
    ...
    public TreeView(String label,Tree t) {
        ...
        filter.add(new FontAction(treeNodes, FontLib.getFont("Arial", 16)));
    ...
    public static void main(String argv[]) {
        ...
        JComponent treeview = new TreeView().showTree(infile, label);
    ...
    public JComponent showTree() {
        return showTree(TREE_CHI, "name");
    }
    
    public JComponent showTree(String datafile, final String label) {
        ...
        final TreeView tview = new TreeView(label,t);
        ...
        search.setFont(FontLib.getFont("Arial", Font.PLAIN, 11));
        ...
        title.setFont(FontLib.getFont("Arial", Font.PLAIN, 16));
