...
public class HypRelationPanel_new extends JPanel {
	...
	public HypRelationPanel_new() {
		...
		htmldirTf.setText("F:\\DOFT-data\\hyperExtraction\\Data_structure\\html");
		...
		this.add(egJsp);
		this.add(motifBtn);
		argSp.setBounds(10, 60, 400, 200);
		egJsp.setBounds(430, 70, 480, 190);
		motifBtn.setBounds(920, 130, 90, 60);
		...
		motifBtn.addActionListener(new ActionListener() { // 此处添加“Motif”按钮处理程序
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (path.length() == 0) {
					JOptionPane
							.showMessageDialog(HypRelationPanel_new.this,
		...
		this.add(chartJsp);
		annotationSp.setBounds(10, 260, 400, 230);
		annotationBtn.setBounds(920, 350, 90, 60);
		...
		TTableColumn columnSourceURLName = new TTableColumn("sourceURLName",
				"sourceURLName", new twaver.table.renderer.StringRenderer());
		TTableColumn columnToURLName = new TTableColumn("toURLName",
				"toURLName", new twaver.table.renderer.StringRenderer());
		TTableColumn columnRelation = new TTableColumn("relation", "relation",
				new twaver.table.renderer.StringRenderer());
		columnSourceURLName.setColumnWith(150);
		columnToURLName.setColumnWith(150);
		columnRelation.setColumnWith(80);
		...
		hypJsp.setBounds(10, 500, 900, 250);
		hypBtn.setBounds(920, 580, 90, 60);
